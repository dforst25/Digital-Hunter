...
def main():
    ...
    coll_name = os.getenv("COLL_NAME", "attack")
    mongo_client = MongoConnector(mongo_uri, coll_name, logger)
    bootstrap_servers = os.getenv("BOOTSTRAP_SERVERS", "localhost:9092")
    topic_name = os.getenv("TOPIC_NAME", "attack")
    error_topic_name = os.getenv("ERROR_TOPIC_NAME", "error_signals_dlq")
    ...
    while True:
        ...
        try:
            ...
            continue
        mongo_client.insert_is_attacked(message.get("entity_id"))
